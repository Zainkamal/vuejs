<script setup>
// import Child from "./components/Mamapulsa.vue";
 ...
 * Todo *
  <div class="container">
    <div class="wrapper">
      <button @click="todo.page = 'page1'" :class="todo.page == 'page1' ? 'active' : ''">
        All Todos
      </button>
      <button @click="todo.page = 'page2'" :class="todo.page == 'page2' ? 'active' : ''">
        Completed Todos
      </button>
      <button @click="todo.page = 'page3'" :class="todo.page == 'page3' ? 'active' : ''">
        Uncompleted Todos
      </button>
    </div>
    <hr />
    ...
    <div v-if="todo.page === 'page1'" class="wrapper">
      ...
      <div v-if="filteredTodos.length">
         ...
         * item.completed = !item.completed * 
          <div class="listItem">
            <li @dblclick="checkList(index)" :class="item.completed ? 'completed' : ''">
              {{ item.title }}
            </li>
            <div>
              <button @dblclick="
